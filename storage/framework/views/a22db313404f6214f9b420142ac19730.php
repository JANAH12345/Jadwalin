<?php $__env->startSection('title', 'Beranda - Jadwalin'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="hero" id="beranda">
        ...
        <div class="hero-slider">
            <div class="hero-slide active" style="background-image: url('<?php echo e(asset("images/ruang marketing.jpeg")); ?>');"></div>
            <div class="hero-slide" style="background-image: url('<?php echo e(asset("images/market.jpeg")); ?>');"></div>
        </div>
        ...
        <div class="hero-actions">
            ...
            <a href="<?php echo e(route('user.jadwal')); ?>" class="btn btn-outline" style="padding: 0.85rem 2.2rem; font-size: 1rem;">Lihat Jadwal</a>
        </div>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp 8.2\htdocs\skema_aplikasi\resources\views/user/landing.blade.php ENDPATH**/ ?>