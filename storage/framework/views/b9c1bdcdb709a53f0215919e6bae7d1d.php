<?php $__env->startSection('title', 'Admin Dashboard - Jadwalin'); ?>
...
<div class="content-section active" id="section-dashboard">
    ...
    <div class="welcome-banner">
        <div class="welcome-title">Selamat Datang, <?php echo e(explode(' ', Auth::check() ? Auth::user()->name : 'Admin')[0]); ?>!</div>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value" id="statTotal"><?php echo e($jadwals->count()); ?></div>
                <div class="stat-change">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />
                    </svg>
                    +<?php echo e($jadwals->where('created_at', '>=', now()->startOfMonth())->count()); ?> bulan ini
                </div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value" id="statHariIni"><?php echo e($jadwals->where('status', 'hari ini')->count()); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value" id="statSelesai"><?php echo e($jadwals->where('status', 'selesai')->count()); ?></div>
                <div class="stat-change">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />
                    </svg>
                    <?php echo e($jadwals->count() > 0 ? round(($jadwals->where('status', 'selesai')->count() / $jadwals->count()) * 100) : 0); ?>% selesai
                </div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value" id="statBatal"><?php echo e($jadwals->where('status', 'batal')->count()); ?></div>
                <div class="stat-change" style="color: #ef4444;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6 9 12.75l4.286-4.286a11.948 11.948 0 0 1 4.306 6.43l.776 2.898m0 0 3.182-5.511m-3.182 5.51-5.511-3.181" />
                    </svg>
                    <?php echo e($jadwals->count() > 0 ? round(($jadwals->where('status', 'batal')->count() / $jadwals->count()) * 100, 1) : 0); ?>% dari total
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($jadwals->count()); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($jadwals->count() > 0 ? round(($jadwals->where('status', 'selesai')->count() / $jadwals->count()) * 100) : 0); ?>%</div>
                <div class="stat-change"><?php echo e($jadwals->where('status', 'selesai')->count()); ?> kegiatan selesai</div>
            </div>
        </div>
        <div class="stat-card">
            <div class="stat-icon blue">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($jadwals->where('status', 'selesai')->unique('nama_tempat')->count()); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($jadwals->where('status', 'batal')->count()); ?></div>
                <div class="stat-change" style="color: #ef4444;"><?php echo e($jadwals->count() > 0 ? round(($jadwals->where('status', 'batal')->count() / $jadwals->count()) * 100, 1) : 0); ?>% dari total</div>
            </div>
        </div>
    </div>
</div>
...
// SAMPLE DATA
// ============================================================
let jadwalData = <?php echo json_encode($jadwals, 15, 512) ?>;
let marketingData = <?php echo json_encode($marketings, 15, 512) ?>;
let adminData = <?php echo json_encode($admins, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp 8.2\htdocs\skema_aplikasi\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>