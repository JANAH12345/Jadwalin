...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            ...
            <form id="loginForm" action="<?php echo e(url('/admin/login')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username" class="form-control" placeholder="Masukkan username admin" required value="<?php echo e(old('username')); ?>" autocomplete="off">
                </div>
...
<?php /**PATH C:\xampp 8.2\htdocs\skema_aplikasi\resources\views/admin/login.blade.php ENDPATH**/ ?>