...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Jadwalin'); ?></title>
...
<body>
    ...
    <nav class="navbar">
        <a href="<?php echo e(url('/')); ?>" class="navbar-brand">
            <img src="<?php echo e(asset('images/logo-ibik.png')); ?>" alt="Logo IBIK" style="width: 38px; height: 38px; object-fit: contain;">
            Jadwalin
        </a>

        <div class="navbar-menu">
            <a href="<?php echo e(url('/#beranda')); ?>" class="nav-link">Beranda</a>
            <a href="<?php echo e(url('/#tentang')); ?>" class="nav-link">Tentang</a>
            <!-- Nav Kelola Jadwal (Redirect by auth middleware if not logged in) -->
            <a href="<?php echo e(route('user.jadwal')); ?>" class="nav-link <?php echo e(request()->routeIs('user.jadwal') ? 'active' : ''); ?>">Kelola Jadwal</a>
            <a href="<?php echo e(url('/#kontak')); ?>" class="nav-link">Kontak</a>
        </div>

        <div class="navbar-right" style="position: absolute; right: 8rem;">
            <?php if(Auth::check() && Auth::user()->role === 'marketing'): ?>
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-primary" style="padding: 10px 20px; border-radius: 99px; display: inline-flex; align-items: center; gap: 8px;">
    ...
    <!-- Footer -->
    <footer>
        &copy; <?php echo e(date('Y')); ?> Jadwalin. All rights reserved.
    </footer>
...
<?php /**PATH C:\xampp 8.2\htdocs\skema_aplikasi\resources\views/layouts/user.blade.php ENDPATH**/ ?>