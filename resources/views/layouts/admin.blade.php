...
<head>
    ...
    <title>Jadwalin - @yield('title', 'Admin Dashboard')</title>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
        <div class="sidebar-brand-icon">
            <img src="{{ asset('images/logo-ibik.png') }}" alt="Logo IBIK" style="width: 32px; height: 32px; object-fit: contain;">
        </div>
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user-mini">
            <div class="sidebar-user-avatar">{{ strtoupper(substr(Auth::check() ? Auth::user()->name : 'Admin', 0, 1)) }}</div>
            <div class="sidebar-user-info">
                <div class="sidebar-user-name">{{ explode(' ', Auth::check() ? Auth::user()->name : 'Admin')[0] }}</div>
    ...
    <header class="navbar">
        ...
        <div class="navbar-right">
            ...
            <div class="navbar-profile">
                <div class="profile-avatar">{{ strtoupper(substr(Auth::check() ? Auth::user()->name : 'Admin', 0, 2)) }}</div>
                <div class="profile-info">
                    <div class="profile-name">{{ explode(' ', Auth::check() ? Auth::user()->name : 'Admin')[0] }}</div>
