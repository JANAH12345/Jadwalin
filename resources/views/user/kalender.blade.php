...
@section('title', 'Marketing Dashboard - Jadwalin')
        ...
        <aside class="sidebar-section">
            <div class="sidebar-card">
                ...
                <div class="upcoming-list">
                    @forelse($stats['mendatang'] as $up)
                        <div class="upcoming-item">
                            <div class="up-date">{{ date('d M Y', strtotime($up->tanggal)) }}</div>
                            <div class="up-title">{{ $up->nama_kegiatan }}</div>
                            <div class="up-place">📍 {{ $up->nama_tempat }}</div>
                        </div>
                    @empty
